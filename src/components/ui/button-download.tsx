        ...
        >
            ...
            {downloadStatus === "downloaded" && (
                <>
                    ...
                    <span className="t">CV Downloaded✔️</span>
                </>
            )}
            {downloadStatus === "complete" && <span className="text-primary">CV Downloaded✔️</span>}
            {downloadStatus === "downloading" && (
                <div
                    className="absolute bottom-0 z-[3] h-full left-0 bg-primary inset-0 transition-all duration-900ms ease-in-out"
